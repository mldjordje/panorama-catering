...
const CategoriesSection = ({ heading = 1, paddingTop = 0, type = 1, columns }) => {
  ...
  return (
    <>
        {/* categories */}
        <section className={`sb-p-${paddingTop}-60 sb-categories-light sb-soft-reveal`}>
            <div className="container">
                ...
                <div className="row">
                    ...
                    <div className={columnsClass} key={`categories-item-${key}`}>
                        <a href={item.link} className={type == 1 ? "sb-categorie-card sb-categorie-card-2 sb-categorie-card--light sb-mb-30" : "sb-categorie-card sb-categorie-card--light sb-mb-30"}>
